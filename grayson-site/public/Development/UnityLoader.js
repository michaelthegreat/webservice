...
(function() {
 var loadPackage = function(metadata) {
    ...
    var REMOTE_PACKAGE_NAME = typeof Module['locateFile'] === 'function' ?
      ...
      var REMOTE_PACKAGE_SIZE = 10374213;
      var PACKAGE_UUID = 'ae8f4069-eca8-4642-a00c-59aa261ee39f';
...
Module['FS_createPath']('/Managed/mono', '2.0', true, true);
    ...
    DataRequest.prototype = {
      ...
      new DataRequest(0, 35988, 0, 0).open('GET', '/globalgamemanagers');
    new DataRequest(35988, 77836, 0, 0).open('GET', '/globalgamemanagers.assets');
    new DataRequest(77836, 85716, 0, 0).open('GET', '/level0');
    new DataRequest(85716, 1336864, 0, 0).open('GET', '/level1');
    new DataRequest(1336864, 1338033, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(1338033, 1354763, 0, 0).open('GET', '/preserved_derived_types.xml');
    new DataRequest(1354763, 1517595, 0, 0).open('GET', '/resources.assets');
    new DataRequest(1517595, 1575992, 0, 0).open('GET', '/resources.resource');
    new DataRequest(1575992, 1586056, 0, 0).open('GET', '/sharedassets0.assets');
    new DataRequest(1586056, 5324204, 0, 0).open('GET', '/sharedassets1.assets');
    new DataRequest(5324204, 8788488, 0, 0).open('GET', '/Il2CppData/Metadata/global-metadata.dat');
    new DataRequest(8788488, 10285860, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(10285860, 10346588, 0, 0).open('GET', '/Resources/unity_builtin_extra');
    new DataRequest(10346588, 10374213, 0, 0).open('GET', '/Managed/mono/2.0/machine.config');
